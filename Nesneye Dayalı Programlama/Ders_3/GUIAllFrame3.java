...
public class GUIAllFrame3 extends JFrame
{
	...
	private final String cityList[] = {"","Ýstanbul", "Ankara","Ýzmir","Adana","Kocaeli"};
		...
		public void actionPerformed(ActionEvent event) {
			...
			if (event.getSource() == boldcheck || event.getSource() == italiccheck)
			{
				if (boldcheck.isSelected() && italiccheck.isSelected()) 
					font = new Font(last_label.getFont().getFamily(),Font.BOLD + Font.ITALIC,last_label.getFont().getSize());
				else if (boldcheck.isSelected() ) 
					font = new Font(last_label.getFont().getFamily(),Font.BOLD,last_label.getFont().getSize());
				else if (italiccheck.isSelected()) 
					font = new Font(last_label.getFont().getFamily(),Font.ITALIC,last_label.getFont().getSize());
				else
					font = new Font(last_label.getFont().getFamily(),Font.PLAIN,last_label.getFont().getSize());
				last_label.setFont(font);
			}
			
			else if (event.getSource() == blackbutton || event.getSource() == bluebutton || event.getSource() == redbutton)
			{
				if (blackbutton.isSelected())
					last_label.setForeground(Color.black);
				else if (bluebutton.isSelected())
					last_label.setForeground(Color.blue);
				else if (redbutton.isSelected())
					last_label.setForeground(Color.red);
			...
			else if (event.getSource() == citycombo)
			{
				...
				JOptionPane.showMessageDialog(null, "Any other radio button or checkbox is clicked");
	...
	private class NameKeyListener implements KeyListener
	{
		...
		public void keyReleased(KeyEvent e) {
			...
			{
				System.out.println("you cannot enter numeric values in Name and Surname field");
