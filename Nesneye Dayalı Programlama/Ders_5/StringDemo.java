      ...
      while (
        ...
        if (v1.length() < 51) {
          ...
          if (vehicle1.isDeliveredOnTime(reqDelYear)) System.out.println(
            ...
            "Vehicle 1 will be delivered early or late."
          );
          ...
          System.out.println(
            "Position of �stanbul in description: " + posOfIst
          );
          ...
          System.out.println(
            "Position of last �stanbul in description: " + posOfIst
          );
          ...
          System.out.println(
            "Customer Name with trim: *" +
            vehicle1.getCustomerName().trim() +
            "*"
          );
