...
public class Vehicle {
  ...
  public String getStatus() {
    if (vStatus == 'C') return "Completed"; else if (
      vStatus == 'D'
    ) return "On Delivery"; else if (
      vStatus == 'W'
    ) return "Waiting"; else return "Not known";
  }
  ...
  public String getDeliveryCity() {
    if (desc.indexOf("Istanbul") > 0) return "Istanbul"; else if (
      desc.indexOf("Ankara") > 0
    ) return "Ankara"; else return "Other City";
  }
