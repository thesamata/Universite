...
public class Vehicle3 implements Serializable{
	/**
	 * 
	 */
	...
	//empty constructor for stream operations
		public Vehicle3()
		{
			vehicleNo = "";
			prodStart = "";
	...
	//constructor
	public Vehicle3(String dataInput)
	{
		//fixed length data
	...
	{
		return String.format("%s: %s%n%s: %s%n%s: %c%n%s: %s%n%s: %s%n",    
