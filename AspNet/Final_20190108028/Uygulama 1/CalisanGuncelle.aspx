<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CalisanGuncelle.aspx.cs" Inherits="Final_20190108028.CalisanGuncelle" %>
    <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
         <center> <h1>ÇALIŞAN GÜNCELLE</h1> </center> 
        <table class="table" style="margin-top:50px; background-color: lightgrey">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DdlBolum"
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="DdlUnvan"
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                        ControlToValidate="txtBasTrh" ErrorMessage="Başlangıç Tarihi zorunludur" ForeColor="Red"
            ...
            <tr>
                <td>Kaydet</td>
                <td>
                    <asp:Button ID="btnGuncelle" class="btn btn-info" runat="server" Text="Güncelle"
                         ValidationGroup="validgrup1" OnClick="btnGuncelle_Click" />
                       <asp:Button ID="btnSil" class="btn btn-danger" runat="server" Text="Sil" OnClick="btnSil_Click"/>
                </td>
